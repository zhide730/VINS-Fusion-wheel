...
string sData_path = "/home/zzd/knowmeking/kaist-urban38/urban38-pankyo_data/urban38-pankyo";
...
int main(int argc, char *argv[])
{
    if(argc != 2)
	{
		cerr << "./kaist_pub PATH_TO_FOLDER/YOUR_PATH_TO_DATASET/KAIST/urban38/urban38-pankyo \n"
			<< "For example: /home/zzd/knowmeking/kaist-urban38/urban38-pankyo_data/urban38-pankyo"<< endl;
		return -1;
	}
    sData_path = argv[1];
    ...
    while (getline(file_data_stamp, line_str) && ros::ok())
    {
        ...
        {
            const string img_file = "/home/zzd/knowmeking/kaist-urban38/urban38-pankyo_img/urban38-pankyo/image/stereo_left/" + time_str + ".png";
